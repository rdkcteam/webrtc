...
public class CallActivity extends Activity implements AppRTCClient.SignalingEvents,
  ...
  public void onCreate(Bundle savedInstanceState) {
    ...
    roomId="kumar_cam";
    Log.d(TAG, "Kumar - Room ID: " + roomId);
    ...
    Log.d(TAG, "Before creating peerconnectionfactory");
    ...
    if (screencaptureEnabled) {
      ...
      Log.d(TAG, "Before calling startCall");
      startCall();
    }
  }
  ...
  private void onConnectedToRoomInternal(final SignalingParameters params) {
    ...
    logAndToast("Before Calling Creating peer connection");
    ...
    if (signalingParameters.initiator) {
      ...
      if (params.offerSdp != null) {
        logAndToast("Before Calling setremotedescription");
