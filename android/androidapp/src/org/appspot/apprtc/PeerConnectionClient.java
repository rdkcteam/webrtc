...
public class PeerConnectionClient {
  ...
  public void createPeerConnection(final VideoSink localRender,
    ...
    executor.execute(new Runnable() {
      ...
      public void run() {
        try {
          Log.d(TAG, "Beofre calling createMediaConstraintsInternal");
          createMediaConstraintsInternal();

          Log.d(TAG, "Beofre calling createPeerConnectionInternal");
  ...
  private void createPeerConnectionInternal() {
    ...
    Log.d(TAG, "After PeerConnection.RTCConfiguration call.");
    ...
    Log.d(TAG, "After factory.createPeerConnection call.");
    ...
    if (dataChannelEnabled) {
      ...
      Log.d(TAG, "After peerConnection.createDataChanne call.");
    }
    isInitiator = false;
